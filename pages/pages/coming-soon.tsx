...
const ComingSoon = () => {
        ...
        <>
          <div className="countdownlist">
            <div className="countdownlist-item">
              ...
              <div className="count-num">{props.days}</div>
            </div>
            <div className="countdownlist-item">
              <div className="count-title">Hours</div>
              <div className="count-num">{props.hours}</div>
            </div>
            <div className="countdownlist-item">
              <div className="count-title">Minutes</div>
              <div className="count-num">{props.minutes}</div>
            </div>
            <div className="countdownlist-item">
              <div className="count-title">Seconds</div>
              <div className="count-num">{props.seconds}</div>
            </div>
          </div>
        </>
      );
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Coming Soon | Hairpin - Platform</title>
      </Head>
          ...
          <Row className="g-0 justify-content-center">
            <Col xl={4} lg={8}>
              ...
              <div className="text-white text-center mt-5">
                <p className="mb-0">
                  &copy;
                  {new Date().getFullYear()} hairpin. Crafted with{" "}
                  <i className="mdi mdi-heart text-danger"></i> by hairpin
                </p>
              </div>
            </Col>
          </Row>
