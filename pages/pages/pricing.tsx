...
const Pricing = () => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Pricing | Hairpin - Platform</title>
      </Head>
      <div className="page-content">
        <Container fluid={true}>
              ...
              <Row>
                <Col lg={6}>
                  <Card>
                    <Card.Body>
                      <ul
                        className="nav nav-pills plan-nav nav-info mb-4 p-2 d-inline-flex bg-light rounded"
                        id="pills-tab"
                        role="tablist"
                      >
                      ...
                      <ul
                        className="list-unstyled vstack gap-4 text-muted mb-0"
                        id="plan-list"
                      >
                        <li>
                      ...
                      >
                        {item.checked ? (
                          <input
                            ...
                            type="radio"
                            value={item.plan}
                            className="form-check-input plan-radio"
                            name="plan-month"
                            defaultChecked
                          />
                        ) : (
                        ...
                        <label
                          ...
                          htmlFor={"plans" + item.id}
                        >
                          <span className="d-flex align-items-center">
                            <span className="fw-semibold d-block flex-grow-1 fs-15 text-uppercase">
                              {item.plan}
                            </span>
                            {price ? (
                              <span className="month fw-semibold flex-shrink-0 fs-24 text-uppercase">
                                {item.montlyPlane}{" "}
                              ...
                              <span className="annual fw-semibold flex-shrink-0 fs-24 text-uppercase">
                                <small className="fs-16">
                                  <del>{item.delAnnuPlane}</del>
                                </small>{" "}
                                {item.annuPlane}{" "}
                                <small className="fs-12 text-muted">
                                  /Year
          ...
          <Row className="justify-content-center mt-5">
            <Col lg={5}>
              <div className="text-center mb-5">
                <h3 className="fw-semibold fs-22">
          ...
          <Row>
            {(pricingPlans || []).map((item: any, key: number) => (
              <Col xxl={3} lg={6} key={key}>
                <Card
                  className={
                    "pricing-box card-animate shadow-lg border-0 border-top border-2 rounded-0 rounded-bottom border-" +
                    item.topBorderColor
                  }
                >
                  {item.popular && (
                    <div className="p-1 bg-info bg-opacity-10 text-center text-info fw-semibold">
                      <span>
                        <i className="ri-flashlight-fill align-bottom me-1"></i>{" "}
                        Most Popular Choice
                      </span>
                    </div>
                  )}
                  <Card.Body className="m-2 p-4">
                    ...
                    <div className="mt-3 pt-2">
                      <Link
                        ...
                        className={
                          item.currentplan
                            ? "btn btn-danger disabled w-100"
                            : "btn btn-info w-100"
                        }
                        scroll={false}
                      >
                        {item.currentplan ? "Your Current Plan" : "Change Plan"}
                      </Link>
                    </div>
                  </Card.Body>
                </Card>
          ...
          <Row className="justify-content-center">
            <Col xxl={9}>
              <Row className="gy-5 gy-lg-4">
                {(pricingPackageplan || []).map((item: any, key: number) => (
                      ...
                      <Card.Body className="p-4 m-2 mt-0">
                        ...
                        <div>
                          <ul className="list-unstyled text-muted vstack gap-3">
                            <li>
                              <div className="d-flex">
                                ...
                                <div className="flex-grow-1">
                                  Upto <b>{item.projects}</b> Projects
                                </div>
                              </div>
                            </li>
                            <li>
                              <div className="d-flex">
                                ...
                                <div className="flex-grow-1">
                                  Upto <b>{item.customers}</b> Customers
                                </div>
                              </div>
                            </li>
                            <li>
                            ...
                            <li>
                              <div className="d-flex">
                                <div
                                  className={
                                    item.support
                                      ? "flex-shrink-0 text-success me-1"
                                      : "flex-shrink-0 text-danger me-1"
                                  }
                                >
                                  {item.support ? (
                                    <i className="ri-checkbox-circle-fill fs-15 align-middle"></i>
                          ...
                          <div className="mt-4">
                            <Link
                              href="#"
                              className={"btn btn-" + item.btnColor + " w-100"}
                              scroll={false}
                            >
                              {item.btntext}
                            </Link>
          ...
          <Row>
            {(pricingPriceplan || []).map((item: any, key: number) => (
              <Col xxl={4} lg={6} key={key}>
                <Card
                  className={
                    item.isRibbon
                      ? "ribbon-box ribbon-fill right bg-opacity-10 border-0 bg-" +
                        item.bgColor
                      : "bg-opacity-10 border-0 bg-" + item.bgColor
                  }
                >
                  {item.isRibbon && (
                    <div className="ribbon ribbon-danger shadow-none">New</div>
                  )}
                  <Card.Body className="p-4 m-2">
                    ...
                    <div>
                      <Link
                        href="#!"
                        className={"w-100 btn btn-" + item.btnColor}
                        scroll={false}
                      >
                        Buy Now
                      </Link>
