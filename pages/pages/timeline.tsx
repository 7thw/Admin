...
const Timeline = () => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Timeline | Hairpin - Platform</title>
      </Head>
                ...
                <div className="timeline-line">
                  <div className="timeline-box">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted mb-0">
                        I'm so impressed by your dedication to learning. I know
                        it wasn't easy when that technology solution you
                        presented didn't work out.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="timeline-box">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted mb-2">
                        ...
                        organizations. Business types range from limited
                        liability companies to sole proprietorships,
                      ...
                      <ul className="list-inline mb-0">
                        <li className="list-inline-item">
                          <div className="d-flex gap-2">
                            <i className="bi bi-emoji-smile text-muted"></i> 3
                            reactions
                          </div>
                        </li>
                        <li className="list-inline-item">
                ...
                <div className="timeline-line">
                  <div className="timeline-box">
                    ...
                    <div className="content">
                      <h5>Project</h5>
                      <p className="text-muted">
                        <b>@jennifer_daina</b> edited <b>hairpin.zip</b> and
                        attach 2 files to the hairpin project.
                      </p>
                            ...
                            <Card.Body className="p-2">
                              <div className="d-flex align-items-center gap-2">
                                ...
                                <div className="flex-grow-1">
                                  <h6 className="mb-1">hairpin.zip</h6>
                ...
                <div className="timeline-line">
                  <div className="timeline-box">
                    ...
                    <div className="content">
                      <h5>
                        New ticket received{" "}
                        <span className="badge bg-info-subtle text-info fs-10 align-middle ms-1">
                          New
                        </span>
                      </h5>
                      <p className="text-muted mb-2">
                      ...
                      <Link scroll={false} href="#" className="link-secondary">
