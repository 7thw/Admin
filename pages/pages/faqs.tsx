...
const Faqs = () => {
  return (
    <React.Fragment>
      <Head>
        <title>FAQs | Hairpin - Platform</title>
      </Head>
              ...
              <div>
                ...
                >
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      An FAQ page{" "}
                      <b>(short for Frequently Asked Question page)</b> is a
                      part of your website that provides answers to common
                      questions, assuages concerns, and overcomes objections.
                      It's a space where customers away from your sales-focused
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      ...
                      <b>
                        your opportunity to communicate with the most important
                        visitors to your website
                      </b>{" "}
                      – those who have begun the decision-making process about
                      whether to do business with you can't fit elsewhere on
                      their website.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                      ...
                      on frequent questions or concerns; however, the format is
                      a useful means of organizing information, and text
                      consisting of questions and their answers may thus be
                      called a FAQ regardless.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="3">
                    <Accordion.Header>What is an online FAQ?</Accordion.Header>
                    <Accordion.Body>
                      FAQs stand for frequently asked questions. It is one of
                      the many crucial pages of your website. It gives your
                      customers answers to recurring and common questions and
                      addresses their concerns public product documentation that
                ...
                >
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      ...
                      than the existing European languages. It will be as simple
                      as Occidental; in fact, it will be Occidental. To an
            ...
            <Col xxl={4} lg={6} className="align-self-center">
              <div className="text-center">
                ...
                <div className="hstack flex-wrap gap-2 justify-content-center">
                  ...
                  >
                    <i className="ri-mail-line label-icon align-middle rounded-pill fs-16"></i>{" "}
                    Email Us
                  </Button>
                  <Button
                    variant="info"
                    ...
                    className="btn-label rounded-pill"
                  >
                    <i className="ri-twitter-line label-icon align-middle rounded-pill fs-16"></i>{" "}
                    Send Us Tweet
                  </Button>
                </div>
              </div>
