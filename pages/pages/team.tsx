...
const Team = () => {
      ...
      if (isEdit) {
        ...
        const newTeam = {
          ...
          userName: `@ ${values.name
            .toLocaleLowerCase()
            .substring(0, values.name.indexOf(" "))}`,
          progress: "0%",
          projects: "0",
          overdue: "0",
          tasks: "0",
  ...
  const currentdata = useMemo(
    () => teamList.slice(indexOfFirst, indexOfLast),
    [teamList, indexOfFirst, indexOfLast]
  );
  ...
  const searchTeamMember = (ele: any) => {
    ...
    if (search) {
      ...
      setCurrentpages(
        teamList.filter((data: any) => data.name.toLowerCase().includes(search))
      );
      setPagination(false);
    } else {
      setCurrentpages(currentdata);
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Team | Hairpin - Platform</title>
      </Head>
                  ...
                  <Card.Body className="p-4 m-2">
                      ...
                      <Col>
                        <div className="flex-shrink-0 me-2">
                          <Button
                            ...
                            className={
                              item.bookmark
                                ? "custom-toggle rounded-circle btn-icon active"
                                : "custom-toggle rounded-circle btn-icon"
                            }
                            data-bs-toggle="button"
                            onClick={(e) => bookmark(e)}
                          >
                            <span className="icon-on">
                              <i className="ri-star-line fs-14"></i>
                            </span>
                    ...
                    <div className="text-center mb-4">
                      <div className="avatar-md mx-auto">
                        <Image
                          src={item.img}
                          alt=""
                          className="member-img img-fluid d-block rounded-3"
                        />
                      </div>
                    </div>
                    <div className="text-center mb-4 pb-3">
                      <Button
                        ...
                        onClick={() => {
                          setShow(true), setInfo(item);
                        }}
                      >
                        <h5 className="fs-17">{item.name}</h5>
                      </Button>
                      <p className="text-muted mb-4">{item.userName}</p>
                      <div className="d-none member-contact">
                        {item.contactNo}
                      </div>
                      <div className="d-none member-email">{item.email}</div>
                      <span className="badge text-success bg-success-subtle member-designation">
                        {item.designation}
                      </span>
                    </div>
                      ...
                      <Col>
                        <div className="flex-shrink-0 me-2">
                          <Button
                            ...
                            size="sm"
                            type="button"
                            className="custom-toggle rounded-circle btn-icon"
                            data-bs-toggle="button"
                            onClick={(e) => bookmark(e)}
                          >
                            <span className="icon-on">
                            ...
                            <span className="icon-off">
                              <i className="ri-heart-fill fs-14"></i>
                            </span>
                          </Button>
                        </div>
                      </Col>
        ...
        <Offcanvas.Body className="profile-offcanvas p-0">
              ...
              <Row>
                ...
                <Dropdown className="col text-end">
                  ...
                  <Dropdown.Menu as="ul" className="dropdown-menu-end">
                    <li>
                      <Dropdown.Item href="#">
                        <i className="ri-eye-line me-2 align-middle"></i>View
                      </Dropdown.Item>
                    </li>
                    <li>
                      <Dropdown.Item href="#">
                        <i className="ri-star-line me-2 align-middle"></i>
                        Favorites
                      </Dropdown.Item>
                    </li>
                    <li>
          ...
          <div className="p-3 text-center">
            <Image
              src={info.img}
              alt=""
              className="avatar-lg img-thumbnail rounded-4 mx-auto profile-img"
            />
            <div className="mt-3">
          ...
          <div className="p-3">
            ...
            <div className="mb-3">
              <p className="text-muted text-uppercase fw-semibold fs-12 mb-2">
                <i className="ri-phone-fill align-middle fs-14 me-1"></i> Number
              </p>
              <h6 className="profile-contact">{info.contactNo}</h6>
            </div>
            <div className="mb-3">
              <p className="text-muted text-uppercase fw-semibold fs-12 mb-2">
                <i className="ri-mail-open-fill align-middle fs-14 me-1"></i>{" "}
                Email
              </p>
            ...
            <div>
              <p className="text-muted text-uppercase fw-semibold fs-12 mb-2">
                <i className="ri-map-pin-fill align-middle fs-14 me-1"></i>{" "}
                Location
              </p>
      ...
      >
        <Modal.Header className="p-4 pb-0" closeButton>
          <Modal.Title id="createMemberLabel" className="fs-5 fw-bold">
            {!!isEdit ? "Edit Member" : "Add New Members"}
          </Modal.Title>
        </Modal.Header>
            ...
            <Row>
              <Col lg={12}>
                    ...
                    <div className="avatar-lg">
                      <div className="avatar-title bg-light rounded-3">
                        <Image
                          ...
                          className="avatar-md rounded-3 h-auto"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="mb-3 mt-4">
                  <Form.Label htmlFor="teammembersName" className="form-label">
                    Name
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <div className="hstack gap-2 justify-content-end">
                  ...
                  <Button variant="success" type="submit" id="addNewMember">
