...
const Settings = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Profile Settings | Hairpin - Platform</title>
      </Head>
            ...
            <Row>
              <Col xxl={12}>
                <Card className="overflow-hidden profile-setting-img">
                  <div
                    className="profile-user rounded profile-basic"
                    style={{
                        ...
                        <div className="border border-dashed p-3 rounded-3 mt-4">
                          ...
                          <div className="d-flex flex-wrap gap-2 fs-15">
                            <Link
                              scroll={false}
                              href="#"
                              className="badge text-info bg-info-subtle"
                            >
                              Photoshop
                            </Link>
                            <Link
                    ...
                    <Row className="align-items-center mt-3 gy-3">
                      <Col md className="order-1">
                        <Nav
                          as="ul"
                          variant="pills"
                          className="animation-nav gap-2 gap-lg-3 flex-grow-1"
                        >
                          <Nav.Item as="li">
                            <Nav.Link
                              className="fs-14"
                          ...
                          <Nav.Item as="li">
                            <Nav.Link className="fs-14" eventKey="experience">
                              {" "}
                          ...
                          <Nav.Item as="li">
                            <Nav.Link className="fs-14" eventKey="privacy">
                      ...
                      >
                        <form action="#">
                          <Row>
                            ...
                            <Col lg={6}>
                              <div className="mb-3">
                                ...
                                <input
                                  ...
                                  defaultValue="edwarddiana@hairpin.ai"
                                />
                              </div>
                            </Col>
                            ...
                            <Col lg={12}>
                              <div className="mb-3">
                                <Form.Label htmlFor="skillsInput">
                                  Skills
                                </Form.Label>
                                <Form.Select>
                            ...
                            <Col lg={12}>
                              <div className="mb-3 pb-2">
                                ...
                                <textarea
                                  ...
                                  rows={3}
                                  defaultValue="Hi I'm Edward Diana,It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family."
                                />
                              </div>
                            </Col>
                            ...
                            <Col lg={4}>
                              <div>
                                ...
                                <div className="position-relative">
                                  ...
                                  />
                                  <button
                                    className="btn btn-link position-absolute top-0 end-0 text-decoration-none text-muted password-addon"
                                    type="button"
                                    id="password-addon"
                                  >
                            ...
                            <div className="table-responsive">
                              <table className="table table-borderless align-middle mb-0">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>
                                      <i className="ri-tablet-line me-2"></i>
                                      Apple iPad Pro
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <i className="ri-macbook-line me-2"></i>
                                      Dell Inspiron 14
                                    </td>
