...
const Status = (props: any) => {
  switch (props.element) {
    case "New":
      return (
        <div className="badge text-info bg-info-subtle fs-10">
          {props.element}
        </div>
      );
    case "Progress":
      return (
        <div className="badge text-primary  bg-primary-subtle fs-10">
          {props.element}
        </div>
      );
    case "Inprogress":
      return (
        <div className="badge badge-soft-warning fs-10">{props.element}</div>
      );
    case "Completed":
      return (
        <div className="badge text-success bg-success-subtle fs-10">
          {props.element}
        </div>
      );
    default:
...
const SimplePage = () => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Profile | Hairpin - Platform</title>
      </Head>
            ...
            <Row>
              <Col lg={12}>
                <Card className="overflow-hidden">
                  <div
                    className="rounded profile-basic position-relative"
                    style={{
                      backgroundImage: `url(${profilebgImg.src})`,
                    ...
                    <div className="position-relative">
                      <div className="mt-n5">
                        <Image
                          src={avatar2}
                          alt=""
                          className="avatar-lg rounded-circle p-1 bg-card-custom mt-n4"
                        />
                      </div>
                    </div>
                    <div className="pt-3">
                      <Row className="justify-content-between gy-4">
                        <Col xl={5} lg={5}>
                          ...
                          <div className="hstack gap-1 mb-3 text-muted">
                            <div className="me-2">
                              <i className="ri-map-pin-user-line me-1 fs-16 align-middle"></i>
                              Phoenix, USA
                            </div>
                            <div>
                              <i className="ri-building-line me-1 fs-16 align-middle"></i>
                              hairpin
                            </div>
                          </div>
                    ...
                    <Row className="mt-2 mt-lg-4 gy-3">
                      <Col lg className="order-1">
                        <Nav
                          as="ul"
                          variant="pills"
                          className="nav-pills animation-nav gap-2 gap-lg-3 flex-grow-1"
                        >
                          <Nav.Item as="li">
                          ...
                          <Card.Body className="p-2">
                            <Card.Body className="bg-primary rounded-3 pb-3">
                              <div className="mb-4 pb-1">
                                <h6 className="fs-16 text-white">
                                  Renew Premium License
                                </h6>
                                <p className="text-white-75 mb-0">
                                  If you purchased an Annual plan and if you've
                                  not canceled the automatic renewal, our
                                  license management system automatically
                                </p>
                              </div>
                            </Card.Body>
                            <Card.Body className="pt-4">
                              ...
                              <div className="mt-4 hstack gap-2">
                                ...
                                <Button variant="soft-danger" className="w-100">
                                  View All Plan
                                </Button>
                              </div>
                            </Card.Body>
                        ...
                        <Card>
                          <Card.Body>
                            ...
                            <div className="d-flex flex-wrap gap-2 fs-15">
                              <Link
                                href="#"
                                className="badge text-primary  bg-primary-subtle"
                                scroll={false}
                              >
                                Photoshop
                              </Link>
                      ...
                      <Col xxl={9}>
                        <Card>
                          <Card.Body>
                            ...
                            <p>
                              A lead designer is responsible for addressing the
                              clients' needs of digital content and coordinating
                              with the design team for the planning and
                              innovation of the visual design and concept.
                              ...
                              designers I spoke with. They highly encourage that
                          ...
                          <Col lg={6}>
                            <Card>
                                          ...
                                          <Button
                                            ...
                                            className={
                                              item.isFollow
                                                ...
                                                : "btn btn-sm btn-outline-info custom-toggle"
                                            }
                                            onClick={(e) => favouriteBtn(e)}
                                          >
                                            <span className="icon-on">
                                              <i className="ri-user-follow-line align-bottom me-1"></i>{" "}
                                              Follow
                                            </span>
                                            <span className="icon-off">
                              ...
                              <Card.Footer className="text-center">
                                <Link href="#!" className="link-secondar">
                                ...
                                >
                                  <ul className="acitivity-timeline-2 list-unstyled mb-0">
                                    ...
                                    <li>
                                      ...
                                      <p>
                                        Lunch time after which sleep just
                                    ...
                                    <li>
                                      ...
                                      <p>
                                        Drink the magical chai, it will ward off
                                        sleep they said. 🤷‍
                                      </p>
                                    </li>
                                    <li>
                                      ...
                                      <p>
                                        The only time I don't feel sleepy cause
                                        it's work out time. I mean walking time.
                                        😹
                                      </p>
                                    </li>
                                    <li>
                                      ...
                                      <p>
                                        Food my tummy needs, sleep my body
                                        needs.👿
                                      </p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      ...
                                      <p>
                                        uh oh!!! fuel low, get some snacks but
                                        wait should I just take a quick nap?🤓{" "}
                                      </p>
                                    </li>
                                    <li>
                                      <div className="time">2:30 PM </div>
                                      <p>
                                        All hail! The time to sleep has finally
                                        arrived.😴😴😴😴😴{" "}
                                      </p>
                                    </li>
                                  </ul>
                          ...
                          <ul className="acitivity-timeline-2 list-unstyled mb-0">
                            ...
                            <li>
                              ...
                              <p className="text-muted fst-italic">
                                ...
                                admin template. The maximum file size for
                            ...
                            <li>
                              <div className="time">01:30 PM</div>
                              <p>
                                Lunch time after which sleep just doesn't want
                                to let go of me. 🤝
                              </p>
                            </li>
                            <li>
                              <div className="time">3:30 PM</div>
                              <p>
                                Drink the magical chai, it will ward off sleep
                                they said. 🤷‍
                              </p>
                            </li>
                            <li>
                              <div className="time">4:30 PM </div>
                              <p>
                                The only time I don't feel sleepy cause it's
                                work out time. I mean walking time. 😹
                              </p>
                            </li>
                            <li>
                              <div className="time">07:00 PM </div>
                            ...
                            <li>
                              <div className="time">10:00 PM </div>
                              <p>
                                uh oh!!! fuel low, get some snacks but wait
                                should I just take a quick nap?🤓{" "}
                              </p>
                            </li>
                            <li>
                              <div className="time">2:30 PM </div>
                                  ...
                                  <Card.Body className="p-4">
                                    ...
                                    <div className="mt-3">
                                      ...
                                      <div className="progress progress-bar-alt-danger progress-sm">
                                        <div
                                          className="progress-bar bg-danger progress-animated wow animated animated"
                                          role="progressbar"
                                          style={{
                                            width: item.progress,
                                            visibility: "visible",
                              ...
                              <Card.Body>
                                ...
                                <div className="mt-2 text-center pt-4 hstack gap-2 justify-content-center">
                                  <div className="avatar-xs">
                                    ...
                                    >
                                      <i className="ri-facebook-fill align-middle"></i>
                                    </Link>
                                  </div>
                                  <div className="avatar-xs">
                                    <Link
                                      scroll={false}
                                      href="#"
                                      className="avatar-title rounded-circle bg-success-subtle text-success"
                                    >
                                      <i className="ri-twitter-fill align-middle"></i>
                                    </Link>
                                  </div>
                                  <div className="avatar-xs">
                                    <Link
                                    ...
                                    >
                                      <i className="ri-linkedin-fill align-middle"></i>
                                    </Link>
                                  </div>
                                </div>
                              </Card.Body>
                              <Card.Body className="hstack gap-2 border-top">
                                <Button variant="soft-info" className="w-100">
                                  Message
                                </Button>
                                <Button
                                  variant="soft-primary"
