...
const Navdata = () => {
  ...
  useEffect(() => {
    ...
    if (isCurrentState === "Components") {
      Router.push("https://hairpin-nextjs-components.vercel.app/");
      document.body.classList.add("twocolumn-panel");
    }
  ...
  const menuItems: any = [
      ...
      subItems: [
        {
          ...
          childItems: [
            { id: 1, label: "Basic", link: "/auth-pages/login/signin-basic" },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/login/signin-basic-2",
            },
        ...
        },
        {
          ...
          childItems: [
            { id: 1, label: "Basic", link: "/auth-pages/singup/signup-basic" },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/singup/signup-basic-2",
            },
          ...
          childItems: [
            {
              id: 1,
              label: "Basic",
              link: "/auth-pages/passwordreset/pass-reset-basic",
            },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/passwordreset/pass-reset-basic-2",
            },
            {
              id: 3,
              label: "Cover",
              link: "/auth-pages/passwordreset/pass-reset-cover",
            },
          ],
        },
        {
          ...
          childItems: [
            {
              id: 1,
              label: "Basic",
              link: "/auth-pages/passwordcreate/pass-change-basic",
            },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/passwordcreate/pass-change-basic-2",
            },
            {
              id: 3,
              label: "Cover",
              link: "/auth-pages/passwordcreate/pass-change-cover",
            },
          ],
        },
        {
          ...
          childItems: [
            {
              id: 1,
              label: "Basic",
              link: "/auth-pages/lockscreen/lockscreen-basic",
            },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/lockscreen/lockscreen-basic-2",
            },
            {
              id: 3,
              label: "Cover",
              link: "/auth-pages/lockscreen/lockscreen-cover",
            },
          ],
        },
        {
          ...
          childItems: [
            { id: 1, label: "Basic", link: "/auth-pages/logout/logout-basic" },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/logout/logout-basic-2",
            },
          ...
          childItems: [
            {
              id: 1,
              label: "Basic",
              link: "/auth-pages/successmessage/success-msg-basic",
            },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/successmessage/success-msg-basic-2",
            },
            {
              id: 3,
              label: "Cover",
              link: "/auth-pages/successmessage/success-msg-cover",
            },
          ],
        },
        {
          ...
          childItems: [
            {
              id: 1,
              label: "Basic",
              link: "/auth-pages/twostepverificaction/twostep-basic",
            },
            {
              id: 2,
              label: "Basic 2",
              link: "/auth-pages/twostepverificaction/twostep-basic-2",
            },
            {
              id: 3,
              label: "Cover",
              link: "/auth-pages/twostepverificaction/twostep-cover",
            },
          ],
        },
        {
          ...
          childItems: [
            ...
            { id: 4, label: "500", link: "/auth-pages/errors/500" },
            {
              id: 5,
              label: "Offline Page",
              link: "/auth-pages/errors/offline",
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      icon: "bi bi-layers",
      isBlankLink: true,
      link: "https://hairpin-nextjs-components.vercel.app/",
      click: function (e: any) {
        e.preventDefault();
